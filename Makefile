...
#
OBJS = server.o request.o segel.o client.o connfdList.o
TARGET = server
...
server: server.o request.o segel.o connfdList.o
	$(CC) $(CFLAGS) -o server server.o request.o segel.o connfdList.o $(LIBS)
